## 🚀 Mini Robotic Projects

---

### 🖐️ **1. Prosthetic Hand Project**

---> [Here](ProstheticHand)

* **📅 Timeline:** February 2023 – April 2023 *(2nd Semester)*
...
* **🔧 Components:**
  ...
  * Arduino Nano ×1
  * EMG Muscle Sensor V3.0 ×1
  * TowerPro MG996R Servo Motors ×5
...
### 🐾 **2. Quadruped Robot Project**

--->[Here](Quadruped-Robot)

* **📅 Timeline:** January 2024 – April 2024 *(4th Semester)*
...
* **🔧 Components:**
  ...
  * Arduino Nano
  * 12× Servo Motors *(3 per leg – 3R configuration)*
  * Buck Converter
  * Sensor Shield
  * LiPo Battery
...
### 🗑️ **3. Robotic Dustbin Collector**
--> [Here](DustBin-Collector-Rover)

* **📅 Timeline:** July 2023 – December 2023 *(3rd Semester)*
...
* **🔧 Components:**
  ...
  * DC Motors ×4
  * Motor Driver Module
  * Joystick Modules ×2 *(1 for rover, 1 for arm)*
...
* **🎮 Control Scheme:**
  ...
  * **Neutral Zone (400–600):** Robot stays stationary
